          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-12 col-lg-9">
                <h2 class="breadcrumbs-custom-title">Payment of Bike Infos</h2>
              </div>
            </div>
          </div>
        </div>
        ...
        <form method="post" action="{{route('locations.store')}}">
                @csrf
					...
					<div class="form-wrap">
						...
						<input  name="duration" type="number" class="form-input" value="1">
					</div>

					<div class="form-input form-price">
						<label> UNIT PRICE: </label>
						<span><strong>{{$bike->prix}} $</strong></span>
					</div>
